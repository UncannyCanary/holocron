...
Live at [holocrondocs.com](https://holocrondocs.com). To read on: [how to use it](docs/using.md), [why it is built this way](decisions.md), and [how it is built](docs/design.md).
...
- [`samples/`](samples/README.md) holds the eight sample documents and their licences.
- [`docs/using.md`](docs/using.md) walks through the product screen by screen.
- [`decisions.md`](decisions.md) explains why it is built this way. [`docs/design.md`](docs/design.md) explains how: the parts, the tables, and the life of a document.
