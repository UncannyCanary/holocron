// Fictional cover page values filled into the Common Paper Mutual NDA template
// (github.com/CommonPaper/Mutual-NDA, CC BY 4.0). No real company or person.

export const nda = {
  title: "Mutual Non-Disclosure Agreement",
  purpose: "Evaluating whether to enter into a business relationship for field data integration.",
  ...
  parties: [
    {
      ...
      noticeAddress: "legal@nimbusanalytics.example",
      signedDate: "2026-02-01",
    },
    {
      name: "Cobalt Field Robotics LLC",
      signerName: "Marcus Ilyin",
      title: "General Counsel",
      noticeAddress: "legal@cobaltfield.example",
      signedDate: "2026-02-01",
    },
  ],
};

// Standard Terms, Common Paper Mutual NDA v1.0, CC BY 4.0. Copied verbatim, minus the
// coverpage_link spans, so the clause numbers and wording match the source exactly.
export const standardTermsClauses = [
  {
